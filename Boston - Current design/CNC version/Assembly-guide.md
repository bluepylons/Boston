...
Acquiring parts is covered by the [ordering guide](https://github.com/bluepylons/Boston/blob/master/Boston%20-%20Current%20design/CNC%20version/README.md)
...
![Zadig Step 1](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/Zadig-1.PNG?raw=true)

b.) Select "List All Devices" in the Options Menu :
![Zadig Step 2](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/Zadig-2.PNG?raw=true)

c.) Select "STM32 Bootloader" in the dropdown menu:
![Zadig Step 3](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/Zadig-3.PNG?raw=true)

d.) Select WinUSB here:
![Zadig Step 4](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/Zadig-4.PNG?raw=true)
...
g.) Download the .bin Vial firmware file [here](https://github.com/bluepylons/Boston/blob/master/Boston%20-%20Current%20design/boston_vial.bin) 
...
![QMK Toolbox Step 1](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/QMK-Toolbox-1.PNG?raw=true)

e.) Press "Open" in QMK Toolbox and navigate to the location of your .bin firmware file. 
![QMK Toolbox Step 2](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/QMK-Toolbox-2.PNG?raw=true)
...
![QMK Toolbox Step 3](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/QMK-Toolbox-3.PNG?raw=true)
...
![Resistors](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/Resistors.JPG?raw=true)
...
![LED-legs-labelled](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/LED-legs-labelled.JPG?raw=true)

Solder the lock LEDs through the LED spacer as shown - the LED spacer only fits on one way. 
![LEDs in spacer](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/LED-in-spacer.JPG?raw=true)
![LEDs soldered on](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/LEDS-installed.JPG?raw=true)
...
![Light pipe installation](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/Light-pipe-installation.JPG?raw=true)
...
![Light pipe retainer installation](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/Light-pipe-retainer-installation.JPG?raw=true)

![Light pipe retainer installed](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/Light-pipe-retainer-installed.JPG?raw=true)
...
![Pressed in threaded insert](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/PEM-nut-pressed-in.jpg?raw=true)
...
![Check that the insert is fully seated](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/PEM-nut-flushness-check.jpg?raw=true)
...
![With screws temporarily in place](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/PEM-nut-with-screws.jpg?raw=true) 

c.) Solder the threaded inserts. You only need enough solder on so that the threaded inserts won't twist or come off. 

d.) Remove the screws.
![Soldered](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/PEM-nut-soldered.jpg?raw=true) 
...
![Daughterboard with cable](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/Daughterboard-w-cable.JPG?raw=true) 

b.) Using M3x5 screws, screw the daugherboard holder into the bottom case. 
![Daughterboard and daughterboard holder installation](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/Daughterboard-installation.JPG?raw=true)
...
![Screwing in the plate](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/Screwing-in-plate.JPG?raw=true)
...
![Connecting the JST cable](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/Plugging-in.JPG?raw=true)
...
![Screwing case together](https://github.com/bluepylons/Boston/blob/master/graphics/Assembly%20guide/Screwing-case-together.JPG?raw=true)
